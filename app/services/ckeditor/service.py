...
import logging
from utils.ckeditor import get_document_from_storage,get_suggestions_from_documentId
...
def get_document_by_id(id: str):
    try:
        data = get_document_from_storage(id)
        return data
...
def get_suggestions_from_document(id:str):
    try:
        data = get_suggestions_from_documentId(id)
        return data
    except req.RequestException as e:
